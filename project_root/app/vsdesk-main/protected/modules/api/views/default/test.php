...
<script>
    $("button").click(function(){
        ...
        $.ajax({
            url:"<?php echo Yii::app()->request->baseUrl; ?>/api?model=inline&key=cGFzczE=", // key is used to authenticate every request which is checked under _authenticate() in controller
