...
class CButtonColumn extends CGridColumn
{
	...
	public $deleteConfirmationYes;
	public $deleteConfirmationNo;
	/**
	...
	protected function initDefaultButtons()
	{
		...
		$this->deleteConfirmationYes=Yii::t('main-ui','Yes');
		$this->deleteConfirmationNo=Yii::t('main-ui','No'); 
        ...
        function() {
            ...
            swal({
            	title: "$this->deleteConfirmation",
                type: "warning",
	            showCancelButton: true,
	            confirmButtonColor: "#3085d6",
	            cancelButtonColor: "#d33",
	            confirmButtonText: "$this->deleteConfirmationYes",
	            cancelButtonText: "$this->deleteConfirmationNo",
