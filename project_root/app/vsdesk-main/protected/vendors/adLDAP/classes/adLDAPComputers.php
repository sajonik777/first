...
class adLDAPComputers {
    ...
    */
    public function info($computerName, $fields = NULL)
    {
        ...
        if ($fields === NULL) { 
            $fields = array("memberof","cn","displayname","dnshostname","distinguishedname","objectcategory","operatingsystem","operatingsystemservicepack","operatingsystemversion", "description", "useraccountcontrol");
        }
