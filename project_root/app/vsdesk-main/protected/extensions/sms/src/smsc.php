...
class Smsc extends CApplicationComponent
{
    ...
    public $debug = true;  // флаг отладки
    public $from = 'api@smsc.ru';   // e-mail адрес отправителя
    public $format;   // формат сообщения
...
// либо массив (<id>, -<код ошибки>) в случае ошибки
    ...
    function send_sms($phones, $message, $translit = 0, $time = 0, $id = 0, $format, $sender = false, $query = "", $files = array())
    {
