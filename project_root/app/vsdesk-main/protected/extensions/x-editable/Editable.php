    ...
    */
    ...
    public function registerAssets()
    {
        ...
        if($this->type == 'datetime') {
            ...
            $cs->registerScriptFile($url . '/js/locales/bootstrap-datetimepicker.'. $this->language .'.js');      
        }               
        ...
        if ($this->type == 'date' && $this->language && substr($this->language, 0, 2) != 'en') {
             ...
             Yii::app()->clientScript->registerScriptFile($localesUrl . '/bootstrap-datetimepicker/locales/bootstrap-datetimepicker.'. str_replace('_', '-', $this->language).'.js', CClientScript::POS_END);
        }
