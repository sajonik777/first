    ...
    protected function registerClientScript()
    {
        ...
        Yii::app()->getClientScript()->registerScript(
            ...
            if (opt.chart.type === 'pie') {
                ...
                opt.series = opt.series.map(series => {
                    series.point = {
                        events: {
                            click: function() { 
                                let href = '/request/?RequestFullFields[slabel][]=' + encodeURIComponent(this.name);
                                let base = window.location.origin;
                                
                                window.location = new URL(href, base);
                            }
                        }
                    }
            ...
            var highchart{$this->getId()} = new Highcharts.Chart(opt);
