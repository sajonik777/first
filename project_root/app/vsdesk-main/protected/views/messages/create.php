...
?>
    ...
    <div class="page-header">
        <h3><?php echo Yii::t('main-ui', 'Create E-mail template'); ?></h3>
    </div>
<div class="box">
    <div class="box-body">
        ...
        <div class="row-fluid">
            ...
            <div class="span6">
                <ul>
                    ...
                    <li><b>{agreed}</b> <?php echo Yii::t('main-ui', 'Agree'); ?></li>
                    <li><b>{denied}</b> <?php echo Yii::t('main-ui', 'Deny'); ?></li>
                    <li><b>{add_info}</b> <?php echo Yii::t('main-ui', 'Need more information'); ?></li>
                </ul>
            </div>
