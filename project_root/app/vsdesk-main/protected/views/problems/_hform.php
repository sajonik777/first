	...
	<div class="box-body">
		...
		<div class="row-fluid">
			<div class="span4">
                ...
                <?php
                echo $form->dropDownListRow($model, 'status', Pstatus::all(), array('class' => 'span12')); ?>
                <?php
                echo $form->dropDownListRow($model, 'priority', Zpriority::all(), array('class' => 'span12')); ?>
			</div>
			<div class="span4">
                <?php
                echo $form->dropDownListRow($model, 'category', ProblemCats::all(), array('class' => 'span12')); ?>
                <?php
                echo $form->dropDownListRow($model, 'service', Service::sall(), array('class' => 'span12')); ?>
			</div>
			<div class="span4">
                <?php
                echo $form->dropDownListRow($model, 'influence', Influence::all(), array('class' => 'span12')); ?>
				<label><?php
                    echo Yii::t('main-ui', 'Service downtime (hh:mm)'); ?>:</label>
                <?php
                $this->widget(
		...
		<div class="row-fluid">
			<p><?php
                echo Yii::t('main-ui', 'Assign units'); ?></p>
            <?php
            $this->widget(
			...
			<br/>
            <?php
            if (Yii::app()->user->checkAccess('uploadFilesProblem')): ?>
            <?php
            if ($model->image == NULL) {
                echo '
