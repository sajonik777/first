 ...
 * @property Files $file
 */
class ContractsFiles extends CActiveRecord
{
    /**
    ...
    public function rules()
    {
        ...
        return array(
            array('contracts_id, file_id', 'required'),
            array('contracts_id, file_id', 'numerical', 'integerOnly' => true),
            // The following rule is used by search().
            // @todo Please remove those attributes that should not be searched.
            array('contracts_id, file_id', 'safe', 'on' => 'search'),
        );
    }
    ...
    public function search()
    {
        ...
        $criteria->compare('contracts_id', $this->contracts_id);
