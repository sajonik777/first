...
class RequestFiles extends CActiveRecord
{
    ...
    public function rules()
    {
        ...
        return array(
            array('request_id, file_id', 'required'),
            array('request_id, file_id', 'numerical', 'integerOnly' => true),
            // The following rule is used by search().
            // @todo Please remove those attributes that should not be searched.
            array('request_id, file_id', 'safe', 'on' => 'search'),
        );
    }
    ...
    public function search()
    {
        ...
        return new CActiveDataProvider($this, array(
            'criteria' => $criteria,
            'pagination' => array(
                'pageSize' => (int)Yii::app()->session['RequestFilesPageCount'] ? Yii::app()->session['RequestFilesPageCount'] : 30,
            ),
        ));
    }
