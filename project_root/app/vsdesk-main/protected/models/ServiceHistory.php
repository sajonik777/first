 ...
 *
 * The followings are the available columns in table 'service_history':
 * @property integer $id
 ...
 */
class ServiceHistory extends CActiveRecord
{
    /**
    ...
    public function relations()
    {
        ...
        return array(
            'user_fk' => array(self::BELONGS_TO, 'CUsers', 'user'),
            'service_fk' => array(self::BELONGS_TO, 'Service', 'sid'),
        );
    }
