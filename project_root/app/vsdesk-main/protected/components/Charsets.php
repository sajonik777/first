...
class Charsets {
    ...
    static function _charset_count_bad($s)
    ...
    static function _charset_count_chars($s)
    ...
    static function _charset_count_pairs($s)
    ...
    static function _charset_alt_win($s)
    {
        for($i=0;$i<strlen($s);$i++)
        {
            $c=ord($s[$i]);
    ...
    static function _charset_koi_win($s)
    {
        $kw = array(
    ...
    static function _charset_prepare($s)
    {
        $r=0;
        $k=0;
    ...
    static function charset_win_lowercase($s)
    {
        for($i=0;$i<strlen($s);$i++)
        {
            $c=ord($s[$i]);
    ...
    static function charset_x_win($s)
    {
// returns a string converted from a best encoding (windows-1251 or koi-8r) to windows-1251
        ...
        switch($r1)
        {
            ...
            case 'utf':
                return self::_charset_utf8_win($s);
            default:
                return $s;
        }
