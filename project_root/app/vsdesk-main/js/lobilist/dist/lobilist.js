...
$(function () {
    ...
    List.prototype = {
        ...
        _init: function () {
            ...
            var $div = $('<div id="'+me.$options.id+'" class="lobilist" style="'+me.$options.defaultStyle+'"></div>').appendTo($wrapper);
        ...
        _createHeader: function () {
            ...
            var $header = $('<div>', {
                ...
                'style': me.$options.defaultBorder,
            });
            var $actions = $('<div>', {
        ...
        _createForm: function () {
            ...
            $('<button>', {
                ...
                html: '<i class="icon icon-remove-circle"></i>'
            }).click(function () {
                $form.addClass('hide');
        ...
        _addItemControls: function ($li, item) {
            ...
            if (me.$options.enableTodoEdit) {
                $itemControlsDiv.append($('<div>', {
                    ...
                    document.location.href = "/crm/leads/update/id/"+item.id;
